...
if ( ($report_display_type=='HTML') or ($report_display_type=='WALL_2') or ($report_display_type=='LIMITED') )
	{
		...
		// echo '<p class="mb-0 text-muted"><span class="badge bg-light text-success mb-0"><i class="ri-arrow-up-line align-middle"></i> 16.24 % </span> vs. previous month</p>';
		// echo '</div>';
		// echo '<div>';
		...
		// echo '<p class="mb-0 text-muted"><span class="badge bg-light text-danger mb-0"><i class="ri-arrow-down-line align-middle"></i> 3.96 % </span> vs. previous month</p>';
		// echo '</div>';
		// echo '<div>';
		// echo '<div class="avatar-sm flex-shrink-0">';
		...
		// echo '<p class="mb-0 text-white-50"><span class="badge bg-white bg-opacity-25 text-white mb-0"><i class="ri-arrow-down-line align-middle"></i> 0.24 % </span> vs. previous month</p>';
		// echo '</div>';
		// echo '<div>';
		// echo '<div class="avatar-sm flex-shrink-0">';
		...
		// echo '<p class="mb-0 text-muted"><span class="badge bg-light text-success mb-0"><i class="ri-arrow-up-line align-middle"></i> 7.05 % </span> vs. previous month</p>';
		// echo '</div>';
		// echo '<div>';
		// echo '<div class="avatar-sm flex-shrink-0">';
		// echo '<span class="avatar-title bg-info-subtle rounded-circle fs-2 material-shadow">';
...
#				{$G='<SPAN class="orange"><B>'; $EG='</B></SPAN>';}
	...
	$Aecho .= "<div class=\"progress-bar bg-success rounded-0\" role=\"progressbar\" style=\"width: $agentcount\" aria-valuenow=\"30\" aria-valuemin=\"0\" aria-valuemax=\"100\"></div>";
...
#	$Aecho .= "  <SPAN class=\"orange\"><B>          </SPAN> - "._QXZ("Balanced call")."</B>\n";
	...
	$Aecho .= '<div class="mt-3">';
	$Aecho .= '<div class="d-flex justify-content-between border-bottom border-bottom-dashed py-2">';
	$Aecho .= '<p class="fw-medium mb-0"><i class="ri-checkbox-blank-circle-fill text-Danger align-middle me-2"></i>Agent chatting</p>';
	$Aecho .='</div><!-- end -->';
	$Aecho .='<div class="d-flex justify-content-between border-bottom border-bottom-dashed py-2">';
	$Aecho .= '<p class="fw-medium mb-0"><i class="ri-checkbox-blank-circle-fill text-Warning align-middle me-2"></i>Agent in email</p>';
	$Aecho .= '</div><!-- end -->';
