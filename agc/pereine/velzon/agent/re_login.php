...
echo '<div>';
echo '<h5 class="text-primary">'._QXZ("Agent web client: Re-Login").'</h5>';
...
echo "<form name=\"vicidial_form\" id=\"vicidial_form\" action=\"$agcPAGE\" method=\"post\" $LOGINformSUBtrigger>";
	echo "<input class=\"form-control\" type=\"hidden\" name=\"DB\" id=\"DB\" value=\"$DB\" />";
	echo "<input class=\"form-control\" type=\"hidden\" name=\"JS_browser_height\" id=\"JS_browser_height\" value=\"\" />";
	echo "<input class=\"form-control\" type=\"hidden\" name=\"JS_browser_width\" id=\"JS_browser_width\" value=\"\" />";
	echo "<input class=\"form-control\" type=\"hidden\" name=\"admin_test\" id=\"admin_test\" value=\"$admin_test\" />";
	echo "<input class=\"form-control\" type=\"hidden\" name=\"LOGINvarONE\" id=\"LOGINvarONE\" value=\"$LOGINvarONE\" />";
	echo "<input class=\"form-control\" type=\"hidden\" name=\"LOGINvarTWO\" id=\"LOGINvarTWO\" value=\"$LOGINvarTWO\" />";
	echo "<input class=\"form-control\" type=\"hidden\" name=\"LOGINvarTHREE\" id=\"LOGINvarTHREE\" value=\"$LOGINvarTHREE\" />";
	echo "<input class=\"form-control\" type=\"hidden\" name=\"LOGINvarFOUR\" id=\"LOGINvarFOUR\" value=\"$LOGINvarFOUR\" />";
	echo "<input class=\"form-control\" type=\"hidden\" name=\"LOGINvarFIVE\" id=\"LOGINvarFIVE\" value=\"$LOGINvarFIVE\" />";
    if (preg_match("/^YES$|^READONLY_LOGIN$|^READONLY_LOGINPHONE$/",$hide_relogin_fields))
		{
		echo "<input class=\"form-control\" type=\"hidden\" name=\"hide_relogin_fields\" id=\"hide_relogin_fields\" value=\"$hide_relogin_fields\" />";
		echo "<input class=\"form-control\" type=\"hidden\" name=\"phone_login\" id=\"phone_login\" value=\"$phone_login\" />";
		echo "<input class=\"form-control\" type=\"hidden\" name=\"phone_pass\" id=\"phone_pass\" value=\"$phone_pass\" />";
		echo "<input class=\"form-control\" type=\"hidden\" name=\"VD_login\" id=\"VD_login\" value=\"$VD_login\" />";
		echo "<input class=\"form-control\" type=\"hidden\" name=\"VD_pass\" id=\"VD_pass\" value=\"$VD_pass\" />";
		}
	if (preg_match("/^READONLY_PHONE$/",$hide_relogin_fields))
		{
		echo "<input class=\"form-control\" type=\"hidden\" name=\"hide_relogin_fields\" id=\"hide_relogin_fields\" value=\"\" />"; # RESET, as this is one-time
		echo "<input class=\"form-control\" type=\"hidden\" name=\"phone_login\" id=\"phone_login\" value=\"$phone_login\" />";
		echo "<input class=\"form-control\" type=\"hidden\" name=\"phone_pass\" id=\"phone_pass\" value=\"$phone_pass\" />";
		}
...
{
echo '<div class="mb-3">';
echo '<label class="form-label">'._QXZ("Phone Login:").'</label>';
echo "<b>$phone_login</b>";
echo '</div>';
echo '<div class="mb-3">';
echo "<label class=\"form-label\">"._QXZ("User Login").":</label>";
echo "<input class=\"form-control\" class=\"form-control\" type=\"text\" name=\"VD_login\" size=\"20\" maxlength=\"20\" value=\"$VD_login\" />";
echo "<label class=\"form-label\">"._QXZ("User Password:")."</label>";
echo "<input class=\"form-control\" type=\"password\" name=\"VD_pass\" size=\"20\" maxlength=\"100\" value=\"$VD_pass\" />";
echo '</div>';
}
...
echo '<div class="mb-3">';
echo "<label class=\"form-label\">"._QXZ("Phone Login:")."</label> ";
echo "<input class=\"form-control\" type=\"text\" name=\"phone_login\" size=\"20\" maxlength=\"20\" value=\"$phone_login\" />";
echo '</div>';
echo '<div class="mb-3">';
echo "<label class=\"form-label\">"._QXZ("Phone Password:")."</label>  ";
echo '<div class="position-relative auth-pass-inputgroup mb-3">';
echo "<input class=\"form-control pe-5 password-input\" id=\"password-input\" type=\"password\" name=\"phone_pass\" size=\"20\" maxlength=\"100\" value=\"$phone_pass\" />";
...
echo "<label class=\"form-label\">"._QXZ("User Password:")."</label>  ";
echo '<div class="position-relative auth-pass-inputgroup mb-3">';
echo "<input class=\"form-control pe-5 password-input\" id=\"password-input\" type=\"password\" name=\"VD_pass\" size=\"20\" maxlength=\"100\" value=\"$VD_pass\" />";
echo '<button class="btn btn-link position-absolute end-0 top-0 text-decoration-none text-muted password-addon material-shadow-none" type="button" id="password-addon"><i class="ri-eye-fill align-middle"></i></button>';
echo '</div>';
}
echo '<div class="mb-3">';
echo "<label class=\"form-label\">"._QXZ("Campaign:")."</label>  ";
echo "<span id=\"LogiNCamPaigns\">$camp_form_code</span>";
echo '</div>';
if ($login_submit_once > 0)
{echo "<input  class=\"btn btn-success w-100\" type=\"submit\" id=\"login_sub\" name=\"login_sub\" value=\""._QXZ("SUBMIT")."\" onclick=\"login_click()\"> &nbsp; ";}
else
{echo "<input  class=\"btn btn-success w-100\" type=\"submit\" name=\"SUBMIT\" value=\""._QXZ("SUBMIT")."\" /> ";}
...
//echo "<label class=\"form-label\"><br />"._QXZ("VERSION:")." $version &nbsp; &nbsp; &nbsp; "._QXZ("BUILD:")." $build</label>";
