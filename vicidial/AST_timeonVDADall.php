...
#	echo "<td width=5 rowspan=2> &nbsp; </td>";
	...
	if ($campaign_allow_inbound > 0)
		...
		echo '<div class="d-flex justify-content-between">';
		echo '<div>';
		echo "<h4 class=\"fw-medium text-muted mb-0\">"._QXZ("calls being placed")."</h4>";
		echo "<h2 class=\"mt-4 ff-secondary fw-semibold\"><span class=\"counter-value\" >$out_total</span></h2>";
	...
	echo '<div class="d-flex justify-content-between">';
	echo '<div>';
	echo "<h4 class=\"fw-medium text-muted mb-0\">"._QXZ("calls ringing")."</h4>";
	echo "<h2 class=\"mt-4 ff-secondary fw-semibold\"><span class=\"counter-value\" >$out_ring</span></h2>";
	echo "<p class=\"mb-0 text-muted\">"._QXZ("Your agents today")."</p>";
	echo '</div>';
	echo '<div>';
	...
	echo '<div class="col-xl-3 col-md-6">';
		...
		echo '<div class="d-flex justify-content-between">';
		echo '<div>';
		echo "<h4 class=\"fw-medium text-white mb-0\">"._QXZ("calls waiting for agents")."</h4>";
		echo "<h2 class=\"mt-4 ff-secondary fw-semibold text-white\"><span class=\"counter-value\" data-target=\"3\">$out_live</span></h2>";
	...
	echo '<div class="col-xl-3 col-md-6">';
		...
		echo '<div class="d-flex justify-content-between">';
		echo '<div>';
		echo "<h4 class=\"fw-medium text-muted mb-0\">"._QXZ("calls in IVR")."</h4>";
		echo "<h2 class=\"mt-4 ff-secondary fw-semibold\"><span class=\"counter-value\" >$in_ivr</span></h2>";
		echo "<p class=\"mb-0 text-muted\">"._QXZ("Your agents today")."</p>";
		echo '</div>';
		echo '<div>';
...
#	echo "<td align='center' valign='middle' rowspan=2>&nbsp;</td>";
	...
	echo '<div class="d-flex justify-content-between">';
	echo '<div>';
	echo "<h4 class=\"fw-medium text-muted mb-0\">"._QXZ("callback queue calls")."</h4>";
	echo "<h2 class=\"mt-4 ff-secondary fw-semibold\"><span class=\"counter-value\">$icbq_live</span></h2>";
	echo "<p class=\"mb-0 text-muted\">"._QXZ("Your agents today")."</p>";
	echo '</div>';
	echo '<div>';
...
echo '<div class="d-flex justify-content-between">';
echo '<div>';
echo "<h4 class=\"fw-medium text-muted mb-0\">"._QXZ("agents logged in")."</h4>";
echo "<h2 class=\"mt-4 ff-secondary fw-semibold\"><span class=\"counter-value\" >$agent_total</span></h2>";
echo "<p class=\"mb-0 text-muted\">"._QXZ("Your agents today")."</p>";
echo '</div>';
echo '<div>';
...
echo '<div class="d-flex justify-content-between">';
echo '<div>';
echo "<h4 class=\"fw-medium text-white mb-0\">"._QXZ("agents in calls")."</h4>";
echo "<h2 class=\"mt-4 ff-secondary fw-semibold text-white\"><span class=\"counter-value\" >$agent_incall$AIDct</h2>";
...
echo '<div class="d-flex justify-content-between">';
echo '<div>';
echo "<h4 class=\"fw-medium text-muted mb-0\">"._QXZ("agents waiting")."</h4>";
echo "<h2 class=\"mt-4 ff-secondary fw-semibold\"><span class=\"counter-value\" >$agent_ready</span></h2>";
echo "<p class=\"mb-0 text-muted\">"._QXZ("Your agents today")."</p>";
echo '</div>';
echo '<div>';
...
echo '<div class="d-flex justify-content-between">';
echo '<div>';
echo "<h4 class=\"fw-medium text-muted mb-0\">"._QXZ("paused agents")."</h4>";
echo "<h2 class=\"mt-4 ff-secondary fw-semibold\"><span class=\"counter-value\">$agent_paused</span></h2>";
...
echo '<div class="d-flex justify-content-between">';
echo '<div>';
echo "<h4 class=\"fw-medium text-white mb-0\">"._QXZ("agents in dead calls")."</h4>";
echo "<h2 class=\"mt-4 ff-secondary text-white fw-semibold\"><span class=\"counter-value\">$agent_dead</span></h2>";
echo "<p class=\"mb-0 text-white\">"._QXZ("Your agents today")."</p>";
echo '</div>';
echo '<div>';
echo '<div class="avatar-sm flex-shrink-0">';
...
echo '<div class="d-flex justify-content-between">';
echo '<div>';
echo "<h4 class=\"fw-medium text-white mb-0\">"._QXZ("agents in dispo")."</h4>";
echo "<h2 class=\"mt-4 ff-secondary fw-semibold text-white\">$agent_incall$AIDct</h2>";
echo "<p class=\"mb-0 text-white\">"._QXZ("Your agents today")."</p>";
echo '</div>';
echo '<div>';
