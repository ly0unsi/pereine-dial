              ...
              <div class="dropdown ms-sm-3 header-item topbar-user">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                  ...
                  <a class="dropdown-item" href="#">
                    ...
                    <span class="align-middle"><a href="<?php echo $admin_home_url_LU ?>"><?php echo _QXZ("HOME"); ?></a></span>
                  </a>
                  <a class="dropdown-item" href="#">
                    <i class="mdi mdi-message-text-outline text-muted fs-16 align-middle me-1"></i>
                    <span class="align-middle"><a href="manager_chat_interface.php"><?php echo _QXZ("Chat"); ?></a></span>
                  </a>
                  <a class="dropdown-item" href="#">
                    <i class="mdi mdi-lifebuoy text-muted fs-16 align-middle me-1"></i>
                    <span class="align-middle"><a href="../agc/timeclock.php?referrer=admin"><?php echo _QXZ("Timeclock"); ?></a></span>
                  </a>
                  <a class="dropdown-item" href="<?php echo $ADMIN ?>?force_logout=1" ><i class="mdi mdi-logout text-muted fs-16 align-middle me-1"></i> <span class="align-middle" data-key="t-logout">Logout</span></a>
                </div>
              </div>
            </div>
          </div>
